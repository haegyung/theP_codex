...
use crate::unified_exec::UnifiedExecDelegateFactory;
...
pub(crate) struct ThreadManagerState {
    ...
    unified_exec_delegate_factory: Option<UnifiedExecDelegateFactory>,
    #[cfg(any(test, feature = "test-support"))]
    #[allow(dead_code)]
    ...
    pub fn new(
        ...
        Self {
            state: Arc::new(ThreadManagerState {
                ...
                session_source,
                unified_exec_delegate_factory: None,
                #[cfg(any(test, feature = "test-support"))]
...
impl ThreadManagerState {
    ...
    pub(crate) async fn spawn_thread_with_source(
        ...
        let CodexSpawnOk {
            ...
            agent_control,
            dynamic_tools,
            self.unified_exec_delegate_factory.clone(),
        )
        .await?;
